...
public:
    ...
    int getValue() const { return value; }  // assert(type->isInt())
    float getfValue() const{ return fvalue; };  // assert(type->isFloat());
...
public:
    ...
    void setfValue(float fvalue) { this->fvalue = fvalue; };

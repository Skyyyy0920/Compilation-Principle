; ModuleID = 'sysy_test.c'
source_filename = "sysy_test.c"
...
6:                                                
  ...
  %8 = icmp slt i32 %7, 5                         ;比较i和5
  br i1 %8, label %9, label %34                   ;跳转指令
...
10:                                               
  ...
  %12 = icmp slt i32 %11, 5                       ;比较j和5
  br i1 %12, label %13, label %30                 ;跳转
...
13:                                               
  ...
  %19 = sdiv i32 %17, %18
  %20 = add nsw i32 %16, %19                      ;%20 = i - j + i / j 
  %21 = load i32, i32* %3, align 4
  %22 = sext i32 %21 to i64
  %23 = getelementptr inbounds [5 x [5 x i32]], [5 x [5 x i32]]* %2, i64 0, i64 %22
  %24 = load i32, i32* %4, align 4
  %25 = sext i32 %24 to i64
  %26 = getelementptr inbounds [5 x i32], [5 x i32]* %23, i64 0, i64 %25              ;a[i][j]
...
34:                                               
  %35 = call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* noundef %5)
